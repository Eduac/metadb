...
/**
 * Servlet to handle user logout. Also does cleanup including releasing item locks for the logged out user.
 * 
 * @author Long L. Ho
...
public class Logout extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			notification = "You have been logged out of MetaDB! Your session has expired!";
