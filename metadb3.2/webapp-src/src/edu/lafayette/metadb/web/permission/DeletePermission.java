...
/**
 * Servlet implementation class DeletePermission
 */
public class DeletePermission extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String notification = "Permission cannot be deleted... Database error";
		try {
			if (PermissionManDAO.deletePermission(projname, username))
